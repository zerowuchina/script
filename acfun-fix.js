 (function() {
 	...
 	if (document.domain.toLowerCase().indexOf("acfun.tv") < 0 && document.domain.toLowerCase().indexOf("bilibili.com") < 0 && document.domain.toLowerCase().indexOf("acfun.tudou.com") < 0) {
 		alert("进AcFun再说...");
 		return
 	}
